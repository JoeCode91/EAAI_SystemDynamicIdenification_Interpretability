...
for i = 1 : reg
    ...
    dis_input = diag(input{i}*input{i}')-2*input{i}*Xsv'+...
        ones(N,1)*(diag(Xsv*Xsv'))';
    dis_comp_input = diag(comp_input{i}*comp_input{i}')-...
        2*comp_input{i}*Xsv'+ones(N,1)*(diag(Xsv*Xsv'))';
